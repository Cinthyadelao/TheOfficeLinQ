...
namespace TheOffice.DataSource
{
    public static class JsonConverter
    {
        public static void ConvertListToJson()
        {
            ...
            string departmentsJson = JsonConvert.SerializeObject(departments, Formatting.Indented);
            ...
            string episodesJson = JsonConvert.SerializeObject(episodes, Formatting.Indented);
